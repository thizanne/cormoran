...
let lexing_loc_error loc err_msg =
  on_loc_error LexingError loc err_msg

let syntax_loc_error loc err_msg =
  on_loc_error SyntaxError loc err_msg

let type_loc_error loc err_msg =
  on_loc_error TypeError loc err_msg

let name_loc_error loc err_msg =
  on_loc_error NameError loc err_msg

let not_implemented_loc_error loc err_msg =
  on_loc_error NotImplementedError loc err_msg
